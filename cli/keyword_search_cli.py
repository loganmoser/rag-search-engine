...
def main() -> None:
    ...
    bm25search_parser.add_argument("limit", nargs="?", default=5, help="Change limit of results to return")
    ...
    match args.command:
        ...
        case "bm25idf":
            ...
            print(
                f"BM25 IDF score of {args.term}: {bm25_idf:.2f}"
            )
        case "bm25tf":
            bm25_tf = bm25_tf_command(args.doc_id, args.term, args.k1, args.b)
            print(
                f"BM25 TF score of {args.term}: {bm25_tf:.2f}"
            )
        case "bm25search":
            print(f"Searching for {args.query}")
